        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizSessions_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizResponses_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lectures_SubjectId_StartsAt",
                table: "Lectures",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResponses_QuizSessionId_QuestionId_StudentId",
                table: "QuizResponses",
                columns: new[] { "QuizSessionId", "QuestionId", "StudentId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResponses_StudentId",
                table: "QuizResponses",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizSessions_LectureId",
                table: "QuizSessions",
                column: "LectureId");
